...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_HHKB] = LAYOUT(
        ...
        ___X___, KC_LGUI, KC_LALT,                            LT(_FN, KC_SPC),                    KC_RALT, KC_RGUI, ___X___, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN] = LAYOUT(
        _______, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          _______,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_F13,          _______,
        _______, ___X___, KC_WH_U, ___X___, ___X___, ___X___, ___X___, KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_VOLD, KC_VOLU,  KC_DEL,          _______,
        _______, KC_WH_L, KC_WH_D, KC_WH_R, ___X___, KC_PSCR, ___X___, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, ___X___,          _______,          _______,
        _______,          ___X___, ___X___, KC_CAPS, ___X___, ___X___, ___X___, ___X___, KC_MPRV, KC_MNXT, KC_MPLY,          _______, _______, _______,
        _______, _______, _______,                            _______,                            _______,MO(_KBFN),_______, _______, _______, _______
    ),
    ...
    [_KBFN] = LAYOUT(
        BOOT_AT, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___,
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, LO_TOGG, RGB_RMOD,RGB_MOD, RGB_VAD, RGB_VAI, RGB_TOG,          ___X___,
        ___X___, ___X___, RGB_SAI, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, RGB_SPD, RGB_SPI, ___X___,          ___X___,
        ___X___, RGB_HUD, RGB_SAD, RGB_HUI, ___X___, ___X___, HH_TOGG, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___,          ___X___,
        ___X___,          ___X___, ___X___, ___X___, ___X___, ___X___, NK_TOGG, ___X___, ___X___, ___X___, ___X___,          ___X___, ___X___, ___X___,
        _______, _______, _______,                            _______,                            _______, _______, _______, ___X___, ___X___, ___X___
    ),
};
// clang-format on

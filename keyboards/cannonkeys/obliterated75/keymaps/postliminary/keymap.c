...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN                Left     Down     Right
	...
	[_BASE] = LAYOUT_all(
	 ...
	 MO(_CAPS),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, ___X___, KC_ENT,           KC_PGUP,
	...
	[_HHKB] = LAYOUT_all(
		...
		KC_LSFT, ___X___, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_PGDN,
		KC_LGUI, ___X___, KC_LALT,                            KC_SPC,                             KC_RALT, MO(_FN),          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN] = LAYOUT_all(
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,                   KC_MPLY,
		___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_MPRV,
		___X___, ___X___, KC_WH_U, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          KC_MNXT,
		___X___, KC_WH_L, KC_WH_D, KC_WH_R, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          KC_VOLU,
		___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___, ___X___, KC_VOLD,
		___X___, ___X___, ___X___,                            ___X___,                           MO(_KBFN),_______,          ___X___, ___X___, ___X___
    ),
	...
	[_KBFN] = LAYOUT_all(
        BOOT_AT, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, BL_BRTG, LO_TOGG, BL_DEC,  BL_INC,  BL_TOGG,                   ___X___,
		NK_TOGG, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,
		___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___,
		___X___, ___X___, ___X___, ___X___, ___X___, ___X___, HH_TOGG, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___,
		___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,          ___X___, ___X___, ___X___,
		___X___, ___X___, ___X___,                            ___X___,                            ___X___, _______,          ___X___, ___X___, ___X___
    ),
};
